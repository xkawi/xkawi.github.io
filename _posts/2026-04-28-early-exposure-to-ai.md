...
In retrospect, iirc, this Sentiment Analysis project was assigned to us, not by choice. So, we were more worried than excited about the challenging project, because from a student's perspective the project requirements actually appeared to be quite complex and challenging, which of course could affect our grade if we could not deliver.
